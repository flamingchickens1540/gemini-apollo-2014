...
public class KinectControl {
    ...
    public static BooleanInputPoll main(EventSource globalPeriodic, IDispatchJoystick disp1, IDispatchJoystick disp2) {
        CluckGlobals.getNode().publish("stick-1", disp1.getAxisSource(2));
        CluckGlobals.getNode().publish("stick-2", disp2.getAxisSource(2));
        ...
        CluckGlobals.getNode().publish("stick-pressed", Mixing.createDispatch(pressed, globalPeriodic));
        return pressed;
    }
}
