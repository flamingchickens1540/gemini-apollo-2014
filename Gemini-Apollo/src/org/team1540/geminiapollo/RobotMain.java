...
public class RobotMain extends SimpleCore {
    ...
    protected void createSimpleControl() {
        ...
        Shooter.createShooter(startedTeleop, duringTeleop, winchMotor, winchEngageSolenoid, winchReleaseSolenoid, winchCurrent, catapultCocked, rearmCatapult, fireButton);
